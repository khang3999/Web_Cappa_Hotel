    ...
    return (
        <>
            <GuestLayout>
                ...
                {status && <div className="alert fade_success .fade"> <button aria-hidden="true" data-dismiss="alert" className="close" type="button">&times;</button> <strong>{status}</strong> </div>}
                                            ...
                                            <div className="col-12">
                                                <div className="mb-5">
                                                    <div className="text-center mb-4">
                                                        <a href="#!">
                                                            <img src="../images/logo.png" alt="BootstrapBrain Logo" width="175" height="57" />
                                                        </a>
                                                    </div>
                                            ...
                                            <div className="row gy-3 overflow-hidden">
                                                ...
                                                <div className="col-12">
                                                    <div className="d-grid">
                                                        <PrimaryButton className="ms-4  bsb-btn-xl rounded w-full" disabled={processing}>
                                        ...
                                        <div className="row">
                                            <div className="col-12">
                                                ...
                                                <div className="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-end">
                                                    <a href={route('login')} className="link-secondary text-decoration-none">
                                                        Login
                                                    </a>
                                                    <a href={route('register')} className="link-secondary text-decoration-none">
                                                        Register
                                                    </a>
                                                </div>
                                            </div>
