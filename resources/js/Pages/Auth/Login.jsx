...
import Loader from "@/Components/LoaderWelcome";
        ...
        <div>
            {isLoading ? (<Loader />) : (
                <GuestLayout>
                    ...
                    {status && <div class="alert fade_success .fade"> <button aria-hidden="true" data-dismiss="alert" class="close" type="button">&times;</button> <strong>{status}</strong> </div>}
